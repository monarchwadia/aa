// Package imageref — imageref_test.go: unit tests for tag parsing, sanitization,
// and default-tag derivation. Covers ADR 1 of v2/docs/architecture/docker-images.md.
package imageref
